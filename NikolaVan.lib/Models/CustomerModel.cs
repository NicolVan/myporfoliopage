...
namespace NikolaVan.lib.Models
{
    public class CustomerModel : _BaseModel
    {
        ...
        //public void CopyDataFrom(EshopCustomer src, CustomerDropDowns dropDowns)
        //{
        //    this.DropDowns = dropDowns;
        //    if (src == null)
        //    {
        ...
        //public void CopyDataTo(EshopCustomer trg, CustomerDropDowns dropDowns)
        //{
        //    this.DropDowns = dropDowns;
        //    trg.pk = this.pk;
        //    trg.Name = this.Name;
        ...
        //public static CustomerModel CreateCopyFrom(EshopCustomer src, CustomerDropDowns dropDowns)
        //{
        ...
        //public static EshopCustomer CreateCopyFrom(CustomerModel src, CustomerDropDowns dropDowns)
        //{
        ...
        //    EshopCustomer customer = repository.GetForOwner(memberId);
        //    if (customer == null)
        //    {
    ...
    //    //public static CustomerListModel CreateCopyFrom(Page<EshopCustomer> srcArray, CustomerDropDowns dropDowns)
    //    //{
    ...
    //    //    foreach (EshopCustomer src in srcArray.Items)
    //    //    {
    ...
    {
        public MemberDropDown MemberCollection { get; set; }
        //public CountryDropDown CountryCollection { get; set; }

        public CustomerDropDowns()
        {
            this.MemberCollection = MemberDropDown.CreateCustomerUserListFromRepository(false);
    ...
    public class CustomerFilterModel : _BaseUserPropModel
    {
        ...
        public static CustomerFilterModel CreateCopyFrom(UserProp src)
        {
        ...
        public static UserProp CreateCopyFrom(CustomerFilterModel src)
        {
            src.UpdateAfterEdit();
 ...
 //       public static CustomerDropDown CreateCopyFrom(Page<EshopCustomer> dataList, bool allowNull, string emptyText, CustomerDropDowns dropDowns)
 //       {
 ...
 //           }
 //           foreach (EshopCustomer dataItem in dataList.Items)
 //           {
